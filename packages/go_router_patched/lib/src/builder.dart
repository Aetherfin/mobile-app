...
// ignore_for_file: deprecated_member_use — onPopPage is deprecated upstream
// in favor of onDidRemovePage, but the replacement has a different signature
// (Page vs Route). Migrates when go_router lands the change.
