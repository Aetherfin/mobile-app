...
/// See also:
///
///  * [AfPredictiveBackFullscreenPageTransitionsBuilder], which is another
...
class AfPredictiveBackPageTransitionsBuilder extends PageTransitionsBuilder {
  /// Creates an instance of a [PageTransitionsBuilder] that matches Android U's
  /// predictive back transition.
  const AfPredictiveBackPageTransitionsBuilder({this.fallbackColor});
...
/// See also:
///
///  * [AfPredictiveBackPageTransitionsBuilder], which is the default Android
...
class AfPredictiveBackFullscreenPageTransitionsBuilder
    extends PageTransitionsBuilder {
  /// Creates an instance of a [PageTransitionsBuilder] that matches Android U's
  /// full screen predictive back transition.
  const AfPredictiveBackFullscreenPageTransitionsBuilder({this.fallbackColor});
...
class _PredictiveBackGestureDetectorState
  ...
  bool get _isEnabled {
    return widget.route.isCurrent &&
        ...
        (widget.route.navigator?.canPop() ?? false);
  }
...
class _PredictiveBackSharedElementPageTransitionState
  ...
  static const double _kMinScale = 0.75;
  ...
  //
  // This is not the same as AfPredictiveBackPageTransitionsBuilder's duration,
...
class _PredictiveBackFullscreenPageTransitionState
  ...
  final Animatable<double> _primaryScaleTween =
  ...
  final ConstantTween<double> _secondaryScaleTweenCurrent =
      ConstantTween<double>(_kScaleStart);
  ...
  final ConstantTween<double> _secondaryOpacityTweenCurrent =
      ConstantTween<double>(_kOpacityFullyOpened);
  ...
  void didChangeDependencies() {
    ...
    final double xShift =
        (screenWidth / _kScreenWidthDivisionFactor) - _kXShiftAdjustment;
    ...
    _secondaryPositionTween = Tween<Offset>(
      begin: Offset(xShift, 0.0),
      end: Offset.zero,
    );
  }
  ...
  Widget _secondaryAnimatedBuilder(BuildContext context, Widget? child) {
    ...
    return Transform.translate(
      ...
      child: Transform.scale(
        ...
        child: Opacity(
          opacity: isCurrent
              ? _secondaryOpacityTweenCurrent.evaluate(
